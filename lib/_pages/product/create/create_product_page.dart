...
class CreateProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isLargeScreen = Breakpoints.largeAndUp.isActive(context);
    CreateProductFormModel formContent =
        _createProductController.buildForm(tipo);
    return SingleChildScrollView(
      child: Container(
          padding: isLargeScreen
              ? const EdgeInsets.symmetric(vertical: 36, horizontal: 48)
                  ...
                  child: Column(
                    children: [
                      Container(
                        margin: inputPadding,
                        child: BazarInput(
                          placeholder: formContent.subtitle,
                      ...
                      Container(
                        margin: inputPadding,
                        child: BazarInput(
                          placeholder: formContent.value,
                          formControlName: "value",
                          inputFormatter:
                              _createProductController.currencyMaskFormatter,
                        ),
                      ),
                      Container(
                          margin: inputPadding,
                              ...
                              ? Column(
                                  children: [
                                    Container(
                                      ...
                                      child: BazarInput(
                                        placeholder:
                                            formContent.quantidadePromo,
                                        formControlName: "quantidadePromo",
                                        inputFormatter:
                                    ...
                                    Container(
                                      margin: inputPadding,
                                      child: BazarInput(
                                        placeholder: formContent.valuePromo,
                                        formControlName: "valuePromo",
                                        inputFormatter: _createProductController
                      ...
                      Container(
                        margin: inputPadding,
                        child: BazarInput(
                          placeholder: formContent.storage,
                            ...
                            child: Row(
                              children: [
                                Expanded(
                                  ...
                                  onPressed:
                                      _bazarGo.onTapGo(context, '/divulgar'),
                                ...
                                Expanded(
                                    child: ElevatedButton(
                                  onPressed: () => _createProductController
                                      .onSubmit(context),
