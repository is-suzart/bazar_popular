...
? Column(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: LoginController().toggleLoginInfo,
...
class _LoginFormState extends State<LoginForm> {
  ...
  @override
  Widget build(BuildContext context) {
    return ReactiveForm(formGroup: _loginController.form, child: Container(
              ...
              children: [
                ...
                Column(
                  children: [
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 16),
                      child: const BazarInput(placeholder: "Email",formControlName: 'email')
),
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 16),
                      child: 
                     const BazarInput(placeholder: "Senha",formControlName: 'password')
