...
class CreateProductController = CreateProductControllerStore
    ...
    switch (type) {
      case 'rifa':
        frontForm = CreateProductFormModel(
            ...
            quantidadePromo:
                "Quantidade para promoção (ex: 4 números por R\$30)",
      ...
      case 'produto':
        frontForm = CreateProductFormModel(
            ...
            isPromo: "Tem valor promocional?",
            quantidadePromo:
                "Quantidade para promoção (ex: 4 produtos por R\$30)",
            valuePromo: "Valor Promocional",
      ...
      case 'evento':
        frontForm = CreateProductFormModel(
            ...
            name: "Nome do evento",
            value:
                "Valor do evento (caso seja de graça, apenas coloque R\$ 00,00)",
            isPromo: "Tem valor promocional?",
            quantidadePromo:
                "Quantidade para promoção (ex: 4 ingressos por R\$30)",
            valuePromo: "Valor Promocional",
    ...
    if (form.valid) {
      ...
      if (result != null) {
        openInfoDialog(
            ...
            _bazarGo.onTapGo(context,
                "/divulgar/${formValues.productType}/finalizar/$result"));
      } else {
